...
SubsolverQPOASES::SubsolverQPOASES(int _nV, int _nC, double* _Q, double* _A)
{
  nV = _nV;
  nC = _nC;
...
SubsolverQPOASES::SubsolverQPOASES(int _nV, int _nC, csc* _Q, csc* _A)
{
  nV = _nV;
  nC = _nC;
...
SubsolverQPOASES::SubsolverQPOASES(const SubsolverQPOASES& rhs) { copy(rhs); }

SubsolverQPOASES::~SubsolverQPOASES() { clear(); }
...
ReturnValue SubsolverQPOASES::solve(bool initialSolve, int& iterations, int& exit_flag, const double* const g,
                                    const double* const lbA, const double* const ubA, const double* const x0,
                                    const double* const y0, const double* const lb, const double* const ub)
{
