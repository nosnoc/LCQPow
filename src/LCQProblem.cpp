...
LCQProblem::~LCQProblem() { clear(); }

ReturnValue LCQProblem::loadLCQP(const double* const _Q, const double* const _g, const double* const _L,
                                 const double* const _R, const double* const _lbL, const double* const _ubL,
                                 const double* const _lbR, const double* const _ubR, const double* const _A,
                                 const double* const _lbA, const double* const _ubA, const double* const _lb,
                                 const double* const _ub, const double* const _x0, const double* const _y0)
{
  ReturnValue ret;
...
ReturnValue LCQProblem::loadLCQP(const char* const Q_file, const char* const g_file, const char* const L_file,
                                 const char* const R_file, const char* const lbL_file, const char* const ubL_file,
                                 const char* const lbR_file, const char* const ubR_file, const char* const A_file,
                                 const char* const lbA_file, const char* const ubA_file, const char* const lb_file,
                                 const char* const ub_file, const char* const x0_file, const char* const y0_file)
{
  ReturnValue ret;
...
ReturnValue LCQProblem::loadLCQP(const csc* const _Q, const double* const _g, const csc* const _L, const csc* const _R,
                                 const double* const _lbL, const double* const _ubL, const double* const _lbR,
                                 const double* const _ubR, const csc* const _A, const double* const _lbA,
                                 const double* const _ubA, const double* const _lb, const double* const _ub,
...
ReturnValue LCQProblem::setConstraints(const double* const L_new, const double* const R_new, const double* const A_new,
...
ReturnValue LCQProblem::setConstraints(const csc* const L_new, const csc* const R_new, const csc* const A_new,
                                       const double* const lbA_new, const double* const ubA_new)
{
...
ReturnValue LCQProblem::setComplementarityBounds(const double* const lbL_new, const double* const ubL_new,
...
ReturnValue LCQProblem::switchToSparseMode()
{
  ...
  if(Utilities::isNullPtr(Q_sparse) || Utilities::isNullPtr(A_sparse) || Utilities::isNullPtr(L_sparse)
     || Utilities::isNullPtr(R_sparse) || Utilities::isNullPtr(C_sparse))
  {
...
ReturnValue LCQProblem::switchToDenseMode()
{
  ...
  // Make sure that all sparse matrices are not null pointer
  if(Utilities::isNullPtr(Q) || Utilities::isNullPtr(A) || Utilities::isNullPtr(L) || Utilities::isNullPtr(R)
     || Utilities::isNullPtr(C))
  {
...
bool LCQProblem::stationarityCheck() { return Utilities::MaxAbs(statk, nV) < options.getStationarityTolerance(); }

bool LCQProblem::complementarityCheck() { return getPhi() < options.getComplementarityTolerance(); }
...
{
  stats.updateTrackingVectors(xk, innerIter, qpIterk, alphak, Utilities::MaxAbs(pk, nV), Utilities::MaxAbs(statk, nV),
                              getObj(), getPhi(), getMerit(), nV);
}
...
int LCQProblem::getNumberOfPrimals() const { return nV; }

int LCQProblem::getNumberOfDuals() const { return nDuals; }

int LCQProblem::getNV() const { return nV; }

int LCQProblem::getNC() const { return nC; }
int LCQProblem::getNComp() const { return nComp; }

Options LCQProblem::getOptions() const { return options; }

void LCQProblem::getOutputStatistics(OutputStatistics& _stats) const { _stats = stats; }
